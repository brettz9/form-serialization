(function (global, factory) {
  ...
  test('radio w/checkbox', function () {
    ...
    strCheck(form, 'foo=bar1&foo=bar3'); // leading checkbox
  ...
  test('deserialize', function () {
    ...
    assert.deepEqual(_toConsumableArray(form.selectMultiple1.selectedOptions).map(function (o) {
      return o.value;
    }), ['opt3', 'Option 4']); // assert.deepEqual(serialize(form, {hash: true}), hash);
  });
  test('deserialize arrays', function () {
    ...
    deserialize(form, hash); // assert.deepEqual(form.arr1, 'xyz');
    ...
    assert.deepEqual(_toConsumableArray($('#selectMultiple1').selectedOptions).map(function (o) {
      return o.value;
    }), ['opt1', 'opt3']);
  });
